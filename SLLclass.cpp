...
// test implementation
int main(){
    SLinkedList<std::string> movies;
    movies.addFront("The Conjuring");
    movies.printList();
    movies.insertAtEnd("The Minecraft Movie");
    movies.printList();
    movies.insertAtEnd("Cars");
    movies.printList();
    movies.removeFront();
    movies.printList();
    movies.insertAtEnd("Cars 2");
    movies.insertAtEnd("Cars 3");
    movies.reverseList(movies.head);
    movies.printList();
